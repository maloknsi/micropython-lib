...
class Device:
    ...
    async def connect(self, timeout_ms=10000, scan_duration_ms=None, conn_interval_ms=None):
        if self._connection:
        ...
        await _connect(DeviceConnection(self), timeout_ms, scan_duration_ms, conn_interval_ms)
